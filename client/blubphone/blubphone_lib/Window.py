...
import logging
logger = logging.getLogger('blubphone_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by BlubphoneWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseBlubphoneWindow object.
        """
        builder = get_builder('BlubphoneWindow')
        new_object = builder.get_object("blubphone_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a BlubphoneWindow object with it in order to finish
        initializing the start of the new BlubphoneWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.blubphone")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('blubphone')
        except ImportError:
            pass
        ...
        try:
            from blubphone import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for blubphone."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for blubphone."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the BlubphoneWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the BlubphoneWindow is closed."""
