...
class AboutDialog(Gtk.AboutDialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('AboutBlubphoneDialog')
        new_object = builder.get_object("about_blubphone_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        to finish initializing the start of the new AboutBlubphoneDialog
        instance.
